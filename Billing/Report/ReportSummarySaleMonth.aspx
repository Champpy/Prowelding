<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ReportSummarySaleMonth.aspx.cs" Inherits="Billing.Report.ReportSummarySaleMonth" %>
            ...
            <div class="panel panel-info panel-info-dark" style="min-height: 370px;">
                <div class="panel-heading panel-heading-dark text-left">
                    <h3 class="panel-title">
                        <strong>
                            <asp:Label ID="lblHeader" runat="server" Text="">Report Summary Sales Monthly</asp:Label>
                        </strong>
                    </h3>
                </div>
                    ...
                    <div style="padding: 0px 15px 15px 15px;">
                        ...
                        <div class="row" style="margin-top: 15px; max-height:350px; overflow:auto;">
                            <div class="col-xs-12">
                                ...
                                <asp:GridView ID="gv" runat="server" Width="1400px" AutoGenerateColumns="False">
                                    <Columns>
                                        <%--<asp:TemplateField>
                                            <HeaderTemplate>
