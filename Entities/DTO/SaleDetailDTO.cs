...
namespace Entities.DTO
{
    public class SaleDetailDTO : TransSaleDetail
    {
        ...
        public string DiscountStr
        {
            get
            {
                return Discount.HasValue ? Discount.Value > 0 ? Discount.Value.ToString("###,##0") : "" : "";
            }
        }
        ...
        public double Total
        {
            ...
            {
                double result = 0;
                result = ((ItemPrice.HasValue ? ItemPrice.Value : 0) * Amount.Value) - (Discount.HasValue ? Discount.Value : 0);
